-- 修改身份验证 和 密码
ALTER USER 'root'@'localhost' IDENTIFIED WITH caching_sha2_password BY '111111';
...
CREATE TABLE `games-users` (
  ...
  `uname` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户名',
